...
class FireStationFormWidget extends StatefulWidget {
  const FireStationFormWidget({
    super.key,
    required this.geolocationFire,
  });

  final LatLng? geolocationFire;

  @override
  State<FireStationFormWidget> createState() => _FireStationFormWidgetState();
}

class _FireStationFormWidgetState extends State<FireStationFormWidget> {
  late FireStationFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FireStationFormModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final fireStationFormGeolocationApiResponse = snapshot.data!;
