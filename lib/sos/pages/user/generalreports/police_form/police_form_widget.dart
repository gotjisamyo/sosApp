...
import 'police_form_model.dart';
export 'police_form_model.dart';

class PoliceFormWidget extends StatefulWidget {
  const PoliceFormWidget({
    super.key,
    required this.geolocationPolice,
  });

  final LatLng? geolocationPolice;

  @override
  State<PoliceFormWidget> createState() => _PoliceFormWidgetState();
}

class _PoliceFormWidgetState extends State<PoliceFormWidget> {
  late PoliceFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PoliceFormModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final policeFormGeolocationApiResponse = snapshot.data!;
