...
import 'police_form_widget.dart' show PoliceFormWidget;
...
class PoliceFormModel extends FlutterFlowModel<PoliceFormWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - API (GeolocationApi)] action in PoliceForm widget.
  ApiCallResponse? resultLatlngVar;
  // Stores action output result for [Custom Action - jsonTostring] action in PoliceForm widget.
  String? toResult;
