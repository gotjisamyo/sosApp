...
class CarRepairFormWidget extends StatefulWidget {
  const CarRepairFormWidget({
    super.key,
    required this.geolocationCarrepai,
  });

  final LatLng? geolocationCarrepai;

  @override
  State<CarRepairFormWidget> createState() => _CarRepairFormWidgetState();
}

class _CarRepairFormWidgetState extends State<CarRepairFormWidget> {
  late CarRepairFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarRepairFormModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final carRepairFormGeolocationApiResponse = snapshot.data!;
