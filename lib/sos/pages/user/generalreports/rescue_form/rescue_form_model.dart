...
import 'rescue_form_widget.dart' show RescueFormWidget;
...
class RescueFormModel extends FlutterFlowModel<RescueFormWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - API (GeolocationApi)] action in RescueForm widget.
  ApiCallResponse? resultLatlngVar;
  // Stores action output result for [Custom Action - jsonTostring] action in RescueForm widget.
  String? toResult;
