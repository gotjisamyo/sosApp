...
class RescueFormWidget extends StatefulWidget {
  const RescueFormWidget({
    super.key,
    required this.geolocationRes,
  });

  final LatLng? geolocationRes;

  @override
  State<RescueFormWidget> createState() => _RescueFormWidgetState();
}

class _RescueFormWidgetState extends State<RescueFormWidget> {
  late RescueFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RescueFormModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final rescueFormGeolocationApiResponse = snapshot.data!;
