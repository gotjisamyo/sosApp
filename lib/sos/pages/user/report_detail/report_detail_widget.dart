...
class _ReportDetailWidgetState extends State<ReportDetailWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportDetailModel());
    ...
    return StreamBuilder<List<UsersRecord>>(
      stream: queryUsersRecord(
        queryBuilder: (usersRecord) => usersRecord.where(
          'uid',
          isEqualTo: widget.report?.postUser?.id,
        ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<UsersRecord> reportDetailUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final reportDetailUsersRecord = reportDetailUsersRecordList.isNotEmpty
            ? reportDetailUsersRecordList.first
            : null;
