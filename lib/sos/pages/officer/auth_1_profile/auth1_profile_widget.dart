...
import 'auth1_profile_model.dart';
export 'auth1_profile_model.dart';

class Auth1ProfileWidget extends StatefulWidget {
  const Auth1ProfileWidget({super.key});

  @override
  State<Auth1ProfileWidget> createState() => _Auth1ProfileWidgetState();
}

class _Auth1ProfileWidgetState extends State<Auth1ProfileWidget>
    with TickerProviderStateMixin {
  late Auth1ProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Auth1ProfileModel());
        ...
        body: Align(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                wrapWithModel(
                  model: _model.headercompos1Model,
                  updateCallback: () => setState(() {}),
                  child: const Headercompos1Widget(),
                ),
                Padding(
