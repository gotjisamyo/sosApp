...
class OficerEditProfileComponantWidget extends StatefulWidget {
  const OficerEditProfileComponantWidget({
    super.key,
    String? title,
  ...
  @override
  State<OficerEditProfileComponantWidget> createState() =>
      _OficerEditProfileComponantWidgetState();
}

class _OficerEditProfileComponantWidgetState
    extends State<OficerEditProfileComponantWidget> {
  late OficerEditProfileComponantModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OficerEditProfileComponantModel());
    ...
    _model.idCardController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.idCard, 0).toString());
    ...
    _model.governmentController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.government, ''));
            ...
            child: AuthUserStreamWidget(
              builder: (context) => TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  labelStyle: FlutterFlowTheme.of(context).labelMedium,
                  hintText: 'กรอก รหัสบัตรประจำตัวประชาชน',
                  hintStyle: FlutterFlowTheme.of(context).labelMedium,
                  errorStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily: 'Inter',
                        color: FlutterFlowTheme.of(context).error,
          ...
          Align(
            ...
            child: Padding(
              ...
              child: FlutterFlowDropDown<String>(
                ...
                onChanged: (val) => setState(() => _model.govDropValue = val),
                width: double.infinity,
                height: 50.0,
                textStyle: FlutterFlowTheme.of(context).bodyMedium,
                hintText: 'กรุณาเลือก อาชีพ...',
                icon: Icon(
          ...
          Padding(
            ...
            child: AuthUserStreamWidget(
              builder: (context) => TextFormField(
                ...
                cursorColor: FlutterFlowTheme.of(context).primary,
                validator:
                    _model.governmentControllerValidator.asValidator(context),
              ),
            ),
          ),
          Align(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  ...
                  await currentUserReference!.update(createUsersRecordData(
                    ...
                    government: _model.governmentController.text,
                    stationName: _model.govDropValue,
                    idCard: int.tryParse(_model.idCardController.text),
                  ));
